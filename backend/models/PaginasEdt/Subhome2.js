...
/**
 * Esquema para la página Subhome2 del portal.
 * Estructura idéntica al Home, pero guardada en su propia colección.
 */
const Subhome2Schema = new mongoose.Schema({
...
// Exporta el modelo con nombre "Subhome2" → colección "Subhome2s"
export default mongoose.model("Subhome2", Subhome2Schema);
